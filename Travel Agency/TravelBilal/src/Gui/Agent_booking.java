 ...
 * @author PAKLAP.pk
 */
public class Agent_booking extends javax.swing.JFrame {

    /**
     * Creates new form Agent_booking
     */
    public Agent_booking() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        update_book1 = new javax.swing.JButton();
        ...
        jPanel1.add(cancel);
        cancel.setBounds(440, 330, 115, 36);
        ...
        add_book.setBounds(230, 80, 190, 50);

        cancel_book.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 14)); // NOI18N
        ...
        jPanel1.add(cancel_book);
        cancel_book.setBounds(230, 150, 190, 50);
        ...
        search_book.setBounds(440, 80, 190, 50);

        update_book1.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 14)); // NOI18N
        update_book1.setText("Update Booking");
        update_book1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                update_book1ActionPerformed(evt);
            }
        });
        jPanel1.add(update_book1);
        update_book1.setBounds(440, 150, 190, 50);
        ...
        setSize(new java.awt.Dimension(716, 544));
    ...
    private void cancel_bookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancel_bookActionPerformed
        // TODO add your handling code here:
        cancel_book book = new cancel_book();
        dispose();
        book.show();
    }//GEN-LAST:event_cancel_bookActionPerformed

    private void update_book1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_book1ActionPerformed
        // TODO add your handling code here:
        update_book book = new update_book();
        dispose();
        book.show();
    }//GEN-LAST:event_update_book1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agent_booking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agent_booking().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton update_book1;
