 ...
 * @author PAKLAP.pk
 */
public class showbook_agent extends javax.swing.JFrame {

    /**
     * Creates new form showbook_agent
     */
    public showbook_agent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(808, 539));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showbook_agent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showbook_agent().setVisible(true);
            }
        });
    }
